...
{ const { dispatch } = useValue(); const [editing, setEditing] = useState(false);
  ...
  return (
    <TextField {...mainProps} {...optionalProps} error={error}
      ...
      color={success ? 'success' : 'primary'} variant="outlined"
      onChange={handleChange}  required
      InputProps={{ endAdornment: ( <InputAdornment position="end">
                    {editing ? (<Avatar src={pendingIcon} sx={{ height: 70 }} />) : 
